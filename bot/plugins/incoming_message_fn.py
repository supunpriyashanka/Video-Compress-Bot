...
async def incoming_start_message_f(bot, update):
        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text(
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Network_hacker_bots_chat).",
                    parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/Network_hacker_bots_chat).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/Network_hacker_bots')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/Network_hcaker_bots_chat')
                ]
            ]
        ),
...
async def incoming_compress_message_f(bot, update):
    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=update.chat.id,
                text="Something went Wrong. Contact my [Support Group](https://t.me/Network_hcaker_bots_chat).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
