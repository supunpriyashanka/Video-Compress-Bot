# VideoCompress
A Telegram Video Compressor Bot By [@Supun_priyashanka](https://t.me/Supun_priyashanka). **This bot works for all!** No need to define each user IDs to use bot. Also works in Group.
...
* If you need more help to Deploy Feel Free to ask in [Support Group](https://t.me/NET_HACKER_BOTs_chat).
...
* `LOG_CHANNEL` - Put Your Bot's Logs Channel's Username. For Help ask in [Support Group](https://t.me/NET_HACKER_BOTs_chat).
...
* `AUTH_USERS` - Put your ID & other Sudo Users IDs. Separate with **Space**. Just for using [Admin Commands](https://github.com/supunpriyashanka/Video-Compress-Bot#admin-commands).

## Optional Configs:
* `UPDATES_CHANNEL` - Put your Channel Username which you want to do Force Sub. But bot should be Admin in that channel. If got any error or not understand anything than ask in [Support Group](https://t.me/NET_HACKER_BOTs_chat).
...
## Follow on:
<p align="left">
<a href="https://github.com/supunpriyashanka"><img src="https://img.shields.io/badge/GitHub-Follow%20on%20GitHub-inactive.svg?logo=github"></a>
</p>
<p align="left">
<a href="https://t.me/NET_HACKER_BOTs_chat"><img src="https://img.shields.io/badge/Telegram-Join%20Telegram%20Group-blue.svg?logo=telegram"></a>
</p>
